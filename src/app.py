...
def login():
    ...
    if request.method == 'POST' and 'email' in request.form and 'password' in request.form and 'rol' in request.form:
        ...
        cursor.execute('SELECT * FROM administrador_global WHERE correoAG = % s AND passwordAG = % s AND rol = % s',(email, password, rol, ))
...
def register():
    ...
    if request.method == 'POST' and 'name' in request.form and 'password' in request.form and 'email' in request.form and 'rol' in request.form:
        ...
        if account:
            ...
            cursor.execute('INSERT INTO administrador_global VALUES (NULL,% s, % s, % s, % s)', (userName, email, password, rol, ))
